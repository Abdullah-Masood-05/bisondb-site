...
- **Indexable types**: Null, numbers, String, ObjectId, Bool, DateTime. Documents, arrays,
  Decimal128, and NaN are not indexable — affected documents are skipped by that index.
...
| Unclean shutdown | indexes rebuild on next open — O(data) startup, zero data loss for acknowledged writes |
